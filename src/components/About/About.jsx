		...
		<div className="py-16  bg-[#F6F5F8] px-4 max-sm:w-full">
			<div className="container m-auto px-6 text-gray-600 md:px-12 xl:px-6 ">
				<div className="space-y-6 md:space-y-0  lg:space-y-0  sm:space-y-0 md:flex md:gap-6  ">
					<div className="md:5/12 h-[95vh] max-sm:w-[100%] max-sm:h-[80vh] max-sm:-mt-10 lg:w-[50%]  ml-10 max-sm:-ml-8 ">
					...
					<div className='w-[26%] max-sm:top-60  h-[63vh] max-sm:h-[51vh] max-sm:w-[75vw] bg-white absolute left-[30%] top-[35vh] max-sm:-ml-6 '>
